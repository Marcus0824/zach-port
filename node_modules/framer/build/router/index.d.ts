 ...
 */
export type { Routes, RouteComponent, RouterAPI } from "./stub.js";
export { ComponentWithPreload, computeRelativePath, inferInitialRouteFromPath, isRoute, Route, Router, RouteId, RoutesProvider, RouterAPIProvider, getPathForRoute, getRouteElementId, useCurrentRouteId, useCurrentPathVariables, useRouter, useRouteAnchor, useRouteHandler, useRoutePreloader, preloadComponent, NotFoundError, } from "./stub.js";
